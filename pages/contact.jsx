                                ...
                                <div className="container-side bg-white p-10 text-default_dark">
                                    <section id={side_contents[0].url.slice(1)} className="p-10">
                                        ...
                                        <p className="my-10 t-18">
                                            Check your local state or territory website for directives and travel
                                            restrictions.
                                        </p>
                                        <p className="my-10 t-18">
                                    ...
                                    <section id={side_contents[1].url.slice(1)} className="p-10">
                                        ...
                                        <p className="my-10 t-18">
                                            For all other enquiries not related to coronavirus (COVID-19), use this
                                            form:
                                        </p>
                                        <div className="p-10">
                                            <p>Phone</p>
                                        ...
                                        <div className="p-10">
                                            ...
                                            <div className="p-10">
                                                <p className="text-default">
                                                    If you are deaf or have a hearing or speech impairment, you can use
                                                    the National Relay Service to access any of the department’s listed
                                                    phone numbers. You can visit the National Relay Service website or
                                                    call 1300 555 727.
                                                </p>
                                            </div>
                                            ...
                                            <div className="p-10 text-default">
                                                <p>
                                                    ...
                                                    Interpreting Service if you need to talk to someone in the
                                                    department. To find out more, visit their website or call 131 450.
                                                </p>
                                            </div>
                                        </div>
                                    </section>
