                        ...
                        <div className="container-side bg-white p-10 text-default_dark">
                            <section id={side_contents[0].url.slice(1)} className="p-10">
                                ...
                                <p className="my-10 t-18">
                                    Your digital vaccination certificate is updated when you receive each dose of
                                    vaccine. This includes a third dose if you are someone with severe immunocompromise
                                    or if it is your booster dose.
                                </p>
                                ...
                                <p className="my-10 t-18">You will need to link your myGov account to Medicare.</p>
                                <p className="my-10 t-18">
                                    You can also see your digital certificate in My Health Record. If you havent logged
                                    into your record yet, you will need to link your myGov account to My Health Record.
                                </p>
                                <p className="my-10 t-18">
                                    You can save your digital certificate to your Apple Wallet or Google Pay if this
                                    option suits you.
                                </p>
                            </section>
                            ...
                            <section id={side_contents[1].url.slice(1)} className="p-10">
                                ...
                                <p className="my-10 t-18">
                                    You can also call the Australian Immunisation Register (AIR) and ask them to send
                                    your statement to you.
                                </p>
                                <p className="my-10 t-18">
                                    If your information is wrong, ask your vaccination provider to correct it with the
                                    AIR.
                                </p>
                            </section>
                            ...
                            <section id={side_contents[4].url.slice(1)} className="p-10">
                                ...
                                <p className="my-10 t-18">
                                    Doctors, health professionals, practice staff and pharmacy assistants can also order
                                    printed copies of a flyer and poster on getting proof of COVID-19 vaccinations.
                                </p>
                            </section>
